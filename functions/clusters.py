...
def filtrerClusters1(A,itA,B,seuil): #On va faire l'intersection de deux sets de clusters, A et B sont des tableaux de centroids, on raffine le set A
...
def optimize_clusters(data, seuil):
    ...
    var = []
    for i in nb:
        model, centroids = nRaffinements2(nit=10, nbClusters=i, seuil=seuil, data_set=data)
        model.fit(data)
